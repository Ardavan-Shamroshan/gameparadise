<x-home.layout>
    <x-slot:title>پرسش های پرتکرار</x-slot:title>
    ...
    <x-home.breadcrumb>
        <x-slot:breadcrumbs>
            ...
            <li class="icon-1"><a > پرسش های پرتکرار </a></li>
        </x-slot:breadcrumbs>
    </x-home.breadcrumb>

    <div class="page-title faqs mt-0" dir="rtl">
        <div class="themesflat-container">
            <div class="row">
                <div class="col-12">
                    <h1 data-wow-delay="0s" class="wow fadeInUp heading text-center">پرسش های پرتکرار</h1>
                    <p data-wow-delay="0.1s" class="wow fadeInUp ">در این بخش به پرسش های متداولی که راجع به خرید اکانت بازی میباشد پاسخ خواهیم داد. اگر پاسخ پرسش خود را پیدا نکردید<br>
                        <span> مستندات ما </span>را بررسی کنید </p>
                </div>
            </div>
        </div>
    </div>

    <div class="tf-section-2 wrap-accordion" dir="rtl">
                    ...
                    <div class="flat-accordion2">
                        ...
                        @forelse($faqs as $faq)
                            <div data-wow-delay="0s" class="wow fadeInUp flat-toggle2">
                                <h2 class="toggle-title">{{ $faq->question ?? '' }}</h2>
                                <div class="toggle-content text">
                                    {!! $faq->answer ?? '' !!}
                                </div>
                            </div>
                        @empty
